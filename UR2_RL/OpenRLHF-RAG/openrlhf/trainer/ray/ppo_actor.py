...
class ActorModelRayActor(BasePPORole):
    ...
    def prepare_datasets(self):
        ...
        # kill
#        with open("/AIRPFS/lwt/eval/dataset/hotpot500/hotpotqa_500.jsonl", "r") as f:
#            rag_data = [json.loads(line) for line in f]
#        with open("/AIRPFS/lwt/eval/dataset/math500/test.jsonl", "r") as f1:
#            math_data = [json.loads(line) for line in f1]   
#        self.eval_dataloader = {'rag': rag_data, 'math': math_data}         
